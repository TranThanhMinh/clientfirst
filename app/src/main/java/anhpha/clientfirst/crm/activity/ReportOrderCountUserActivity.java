 ...
 */
public class ReportOrderCountUserActivity extends BaseAppCompatActivity implements Callback<MAPIResponse<List<MReport>>>,OnChartValueSelectedListener {
    @Bind(R.id.chart1)
    PieChart mChart;
    @Bind(R.id.include)
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText(getString(R.string.month));
        ...
        GetRetrofit().create(ServiceAPI.class)
                .getOrderCountUser(preferences.getStringValue(Constants.TOKEN, "")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == Constants.RESULT_USERS ||resultCode == Constants.RESULT_CALENDAR ){
            MRequestBody mRequestBody = new MRequestBody();
