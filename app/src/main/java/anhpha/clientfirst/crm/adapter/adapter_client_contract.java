...
public class adapter_client_contract extends RecyclerView.Adapter<adapter_client_contract.MyViewHolder> {
    ...
    public adapter_client_contract(Context context, List<CompanyExist> list, Click click) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = lay.inflate(R.layout.item_personnel_contract, null);
