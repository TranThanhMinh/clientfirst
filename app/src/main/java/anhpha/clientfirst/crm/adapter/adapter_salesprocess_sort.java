...
public class adapter_salesprocess_sort extends RecyclerView.Adapter<adapter_salesprocess_sort.MyViewHolder> {
    ...
    public adapter_salesprocess_sort(Context context, List<OrderContractStatusGroup> list, Onclick onclick) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_salesprocess_order, null);
     ...
     //   holder.view2.setVisibility(View.GONE);
        ...
        holder.tvName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                for(OrderContractStatusGroup order : list){
    ...
    //    private View view2;
        ...
        public MyViewHolder(View itemView) {
            ...
            checkBox = (RadioButton) itemView.findViewById(R.id.check);
