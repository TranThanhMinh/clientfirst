...
import anhpha.clientfirst.crm.charting.listener.PieRadarChartTouchListener;
...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
        extends anhpha.clientfirst.crm.charting.charts.Chart<T> {
     ...
     */
    private float mRawRotationAngle = 0;
