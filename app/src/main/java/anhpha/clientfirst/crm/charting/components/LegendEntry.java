package anhpha.clientfirst.crm.charting.components;
...
public class LegendEntry {
    ...
    public LegendEntry(String label,
                       anhpha.clientfirst.crm.charting.components.Legend.LegendForm form,
                       float formSize,
                       float formLineWidth,
     ...
     */
    public anhpha.clientfirst.crm.charting.components.Legend.LegendForm form = anhpha.clientfirst.crm.charting.components.Legend.LegendForm.DEFAULT;
