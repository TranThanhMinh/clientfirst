...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<anhpha.clientfirst.crm.charting.data.BarEntry> implements IBarDataSet {
    ...
    public BarDataSet(List<anhpha.clientfirst.crm.charting.data.BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    @Override
    public anhpha.clientfirst.crm.charting.data.DataSet<anhpha.clientfirst.crm.charting.data.BarEntry> copy() {

        List<anhpha.clientfirst.crm.charting.data.BarEntry> yVals = new ArrayList<anhpha.clientfirst.crm.charting.data.BarEntry>();
        yVals.clear();
     ...
     */
    private void calcEntryCountIncludingStacks(List<anhpha.clientfirst.crm.charting.data.BarEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(List<anhpha.clientfirst.crm.charting.data.BarEntry> yVals) {
