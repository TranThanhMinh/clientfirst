...
import anhpha.clientfirst.crm.charting.interfaces.datasets.ICandleDataSet;
 ...
 */
public class CandleDataSet extends LineScatterCandleRadarDataSet<anhpha.clientfirst.crm.charting.data.CandleEntry> implements ICandleDataSet {
    ...
    public CandleDataSet(List<anhpha.clientfirst.crm.charting.data.CandleEntry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public anhpha.clientfirst.crm.charting.data.DataSet<anhpha.clientfirst.crm.charting.data.CandleEntry> copy() {

        List<anhpha.clientfirst.crm.charting.data.CandleEntry> yVals = new ArrayList<anhpha.clientfirst.crm.charting.data.CandleEntry>();
        yVals.clear();
    ...
    @Override
    protected void calcMinMax(anhpha.clientfirst.crm.charting.data.CandleEntry e) {
