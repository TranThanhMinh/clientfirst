 ...
 */
public abstract class ChartData<T extends IDataSet<? extends anhpha.clientfirst.crm.charting.data.Entry>> {
     ...
     * @param dataSetIndex
     */
    public void addEntry(anhpha.clientfirst.crm.charting.data.Entry e, int dataSetIndex) {
     ...
     * @param axis
     */
    protected void calcMinMax(anhpha.clientfirst.crm.charting.data.Entry e, AxisDependency axis) {
     ...
     * @param dataSetIndex
     */
    public boolean removeEntry(anhpha.clientfirst.crm.charting.data.Entry e, int dataSetIndex) {
    ...
    public boolean removeEntry(float xValue, int dataSetIndex) {
        ...
        anhpha.clientfirst.crm.charting.data.Entry e = dataSet.getEntryForXValue(xValue, Float.NaN);
     ...
     * @return
     */
    public T getDataSetForEntry(anhpha.clientfirst.crm.charting.data.Entry e) {
