 ...
 */
public abstract class DataSet<T extends anhpha.clientfirst.crm.charting.data.Entry> extends BaseDataSet<T> {
    ...
    @Override
    public int getEntryIndex(anhpha.clientfirst.crm.charting.data.Entry e) {
        ...
        if (closest != -1) {
            ...
            if (!Float.isNaN(closestToY)) {
                ...
                while (true) {
                    ...
                    final anhpha.clientfirst.crm.charting.data.Entry value = mValues.get(closest);
