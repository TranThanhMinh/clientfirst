...
import anhpha.clientfirst.crm.charting.formatter.DefaultFillFormatter;
import anhpha.clientfirst.crm.charting.formatter.IFillFormatter;
...
public class LineDataSet extends LineRadarDataSet<anhpha.clientfirst.crm.charting.data.Entry> implements ILineDataSet {
    ...
    public LineDataSet(List<anhpha.clientfirst.crm.charting.data.Entry> yVals, String label) {
        super(yVals, label);
