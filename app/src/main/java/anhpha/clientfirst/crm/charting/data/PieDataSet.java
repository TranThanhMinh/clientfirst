...
public class PieDataSet extends anhpha.clientfirst.crm.charting.data.DataSet<anhpha.clientfirst.crm.charting.data.PieEntry> implements IPieDataSet {
    ...
    public PieDataSet(List<anhpha.clientfirst.crm.charting.data.PieEntry> yVals, String label) {
        super(yVals, label);
//        mShift = Utils.convertDpToPixel(12f);
    }

    @Override
    public anhpha.clientfirst.crm.charting.data.DataSet<anhpha.clientfirst.crm.charting.data.PieEntry> copy() {

        List<anhpha.clientfirst.crm.charting.data.PieEntry> yVals = new ArrayList<>();
