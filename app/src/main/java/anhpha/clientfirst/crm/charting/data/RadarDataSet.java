...
public class RadarDataSet extends LineRadarDataSet<anhpha.clientfirst.crm.charting.data.RadarEntry> implements IRadarDataSet {
    ...
    public RadarDataSet(List<anhpha.clientfirst.crm.charting.data.RadarEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    @Override
    public anhpha.clientfirst.crm.charting.data.DataSet<anhpha.clientfirst.crm.charting.data.RadarEntry> copy() {

        List<anhpha.clientfirst.crm.charting.data.RadarEntry> yVals = new ArrayList<RadarEntry>();
