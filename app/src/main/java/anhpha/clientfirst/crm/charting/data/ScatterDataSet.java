...
import anhpha.clientfirst.crm.charting.charts.ScatterChart;
import anhpha.clientfirst.crm.charting.interfaces.datasets.IScatterDataSet;
import anhpha.clientfirst.crm.charting.renderer.scatter.ChevronDownShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.ChevronUpShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.CircleShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.CrossShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.IShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.SquareShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.TriangleShapeRenderer;
import anhpha.clientfirst.crm.charting.renderer.scatter.XShapeRenderer;
import anhpha.clientfirst.crm.charting.utils.ColorTemplate;

import java.util.ArrayList;
import java.util.List;

public class ScatterDataSet extends LineScatterCandleRadarDataSet<anhpha.clientfirst.crm.charting.data.Entry> implements IScatterDataSet {
    ...
    public ScatterDataSet(List<anhpha.clientfirst.crm.charting.data.Entry> yVals, String label) {
        super(yVals, label);
    }

    @Override
    public anhpha.clientfirst.crm.charting.data.DataSet<anhpha.clientfirst.crm.charting.data.Entry> copy() {

        List<anhpha.clientfirst.crm.charting.data.Entry> yVals = new ArrayList<Entry>();
