...
import anhpha.clientfirst.crm.charting.interfaces.dataprovider.CombinedDataProvider;
 ...
 */
public class CombinedHighlighter extends anhpha.clientfirst.crm.charting.highlight.ChartHighlighter<CombinedDataProvider> implements IHighlighter
{

    /**
     * bar highlighter for supporting stacked highlighting
     */
    protected anhpha.clientfirst.crm.charting.highlight.BarHighlighter barHighlighter;
    ...
    protected List<anhpha.clientfirst.crm.charting.highlight.Highlight> getHighlightsAtXValue(float xVal, float x, float y) {
        ...
        for (int i = 0; i < dataObjects.size(); i++) {
            ...
            if (barHighlighter != null && dataObject instanceof BarData) {
                anhpha.clientfirst.crm.charting.highlight.Highlight high = barHighlighter.getHighlight(x, y);
                ...
                for (int j = 0, dataSetCount = dataObject.getDataSetCount(); j < dataSetCount; j++) {
                    ...
                    List<anhpha.clientfirst.crm.charting.highlight.Highlight> highs = buildHighlights(dataSet, j, xVal, DataSet.Rounding.CLOSEST);
