...
import anhpha.clientfirst.crm.charting.charts.RadarChart;
...
public class RadarHighlighter extends PieRadarHighlighter<RadarChart> {
    ...
    protected anhpha.clientfirst.crm.charting.highlight.Highlight getClosestHighlight(int index, float x, float y) {
        ...
        List<anhpha.clientfirst.crm.charting.highlight.Highlight> highlights = getHighlightsAtIndex(index);
        ...
        for (int i = 0; i < highlights.size(); i++) {
            ...
            anhpha.clientfirst.crm.charting.highlight.Highlight high = highlights.get(i);
     ...
     * @return
     */
    protected List<anhpha.clientfirst.crm.charting.highlight.Highlight> getHighlightsAtIndex(int index) {
        ...
        for (int i = 0; i < mChart.getData().getDataSetCount(); i++) {
            ...
            mHighlightBuffer.add(new anhpha.clientfirst.crm.charting.highlight.Highlight(index, entry.getY(), pOut.x, pOut.y, i, dataSet.getAxisDependency()));
        }
