...
import anhpha.clientfirst.crm.charting.data.CandleEntry;
...
public class Transformer {
     ...
     * @return
     */
    public anhpha.clientfirst.crm.charting.utils.MPPointD getValuesByTouchPoint(float x, float y) {

        anhpha.clientfirst.crm.charting.utils.MPPointD result = anhpha.clientfirst.crm.charting.utils.MPPointD.getInstance(0, 0);
        getValuesByTouchPoint(x, y, result);
        return result;
    }

    public void getValuesByTouchPoint(float x, float y, anhpha.clientfirst.crm.charting.utils.MPPointD outputPoint) {
     ...
     * @return
     */
    public anhpha.clientfirst.crm.charting.utils.MPPointD getPixelForValues(float x, float y) {
        ...
        return anhpha.clientfirst.crm.charting.utils.MPPointD.getInstance(xPx, yPx);
    }
