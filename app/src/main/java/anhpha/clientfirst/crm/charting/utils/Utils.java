...
package anhpha.clientfirst.crm.charting.utils;
...
import anhpha.clientfirst.crm.charting.formatter.DefaultValueFormatter;
import anhpha.clientfirst.crm.charting.formatter.IValueFormatter;
...
public abstract class Utils {
     ...
     */
    public static anhpha.clientfirst.crm.charting.utils.FSize calcTextSize(Paint paint, String demoText) {

        anhpha.clientfirst.crm.charting.utils.FSize result = anhpha.clientfirst.crm.charting.utils.FSize.getInstance(0, 0);
     ...
     */
    public static void calcTextSize(Paint paint, String demoText, anhpha.clientfirst.crm.charting.utils.FSize outputFSize) {
    ...
    public static void velocityTrackerPointerUpCleanUpIfNecessary(MotionEvent ev,
        ...
        // Check the dot contract of current velocities.
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
        ...
        if (angleDegrees != 0.f) {
            ...
            if (anchor.x != 0.5f || anchor.y != 0.5f) {
                final anhpha.clientfirst.crm.charting.utils.FSize rotatedSize = getSizeOfRotatedRectangleByDegrees(
                ...
                anhpha.clientfirst.crm.charting.utils.FSize.recycleInstance(rotatedSize);
            }
    ...
    public static void drawMultilineText(Canvas c, String text,
                                         float x, float y,
                                         TextPaint paint,
                                         anhpha.clientfirst.crm.charting.utils.FSize constrainedToSize,
                                         MPPointF anchor, float angleDegrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static anhpha.clientfirst.crm.charting.utils.FSize getSizeOfRotatedRectangleByDegrees(anhpha.clientfirst.crm.charting.utils.FSize rectangleSize, float degrees) {
     ...
     * @return A Recyclable FSize instance
     */
    public static anhpha.clientfirst.crm.charting.utils.FSize getSizeOfRotatedRectangleByRadians(anhpha.clientfirst.crm.charting.utils.FSize rectangleSize, float radians) {
        return getSizeOfRotatedRectangleByRadians(rectangleSize.width, rectangleSize.height,
                radians);
    }
     ...
     * @return A Recyclable FSize instance
     */
    public static anhpha.clientfirst.crm.charting.utils.FSize getSizeOfRotatedRectangleByDegrees(float rectangleWidth, float
     ...
     * @return A Recyclable FSize instance
     */
    public static anhpha.clientfirst.crm.charting.utils.FSize getSizeOfRotatedRectangleByRadians(float rectangleWidth, float
            rectangleHeight, float radians) {
        return anhpha.clientfirst.crm.charting.utils.FSize.getInstance(
