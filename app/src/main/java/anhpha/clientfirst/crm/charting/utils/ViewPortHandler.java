...
public class ViewPortHandler {
    ...
    public anhpha.clientfirst.crm.charting.utils.MPPointF getContentCenter() {
        return anhpha.clientfirst.crm.charting.utils.MPPointF.getInstance(mContentRect.centerX(), mContentRect.centerY());
    }
    ...
    public void setDragOffsetX(float offset) {
        mTransOffsetX = anhpha.clientfirst.crm.charting.utils.Utils.convertDpToPixel(offset);
    }
