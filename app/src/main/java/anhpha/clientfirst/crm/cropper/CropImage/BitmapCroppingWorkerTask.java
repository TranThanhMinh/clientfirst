...
final class BitmapCroppingWorkerTask extends AsyncTask<Void, Void, BitmapCroppingWorkerTask.Result> {
     ...
     */
    private final WeakReference<CropImage_View> mCropImageViewReference;
     ...
     */
    private final CropImage_View.RequestSizeOptions mReqSizeOptions;
    ...
    BitmapCroppingWorkerTask(CropImage_View cropImageView, Bitmap bitmap, float[] cropPoints,
                             int degreesRotated, boolean fixAspectRatio, int aspectRatioX, int aspectRatioY,
                             int reqWidth, int reqHeight, boolean flipHorizontally, boolean flipVertically, CropImage_View.RequestSizeOptions options,
    ...
    BitmapCroppingWorkerTask(CropImage_View cropImageView, Uri uri, float[] cropPoints,
                             ...
                             boolean flipHorizontally, boolean flipVertically, CropImage_View.RequestSizeOptions options,
                             Uri saveUri, Bitmap.CompressFormat saveCompressFormat, int saveCompressQuality) {
    ...
    protected void onPostExecute(Result result) {
        if (result != null) {
            ...
            if (!isCancelled()) {
                CropImage_View cropImageView = mCropImageViewReference.get();
