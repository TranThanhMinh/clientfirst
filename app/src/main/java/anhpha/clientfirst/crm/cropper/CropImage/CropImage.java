...
public final class CropImage {
    ...
    public static final class ActivityBuilder {
         ...
         */
        public ActivityBuilder setCropShape(@NonNull CropImage_View.CropShape cropShape) {
         ...
         */
        public ActivityBuilder setGuidelines(@NonNull CropImage_View.Guidelines guidelines) {
         ...
         */
        public ActivityBuilder setScaleType(@NonNull CropImage_View.ScaleType scaleType) {
         ...
         * Uses {@link CropImage_View.RequestSizeOptions#RESIZE_INSIDE} option.<br>
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
            return setRequestedSize(reqWidth, reqHeight, CropImage_View.RequestSizeOptions.RESIZE_INSIDE);
        }
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight, CropImage_View.RequestSizeOptions options) {
     ...
     */
    public static final class ActivityResult extends CropImage_View.CropResult implements Parcelable {
