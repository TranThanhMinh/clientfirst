 ...
 */
public class CropImageActivity extends BaseAppCompatActivity implements CropImage_View.OnSetImageUriCompleteListener, CropImage_View.OnCropImageCompleteListener {

    /**
     * The crop image view library widget used in the activity
     */
    private CropImage_View mCropImageView;
    ...
    @Override
    public void onSetImageUriComplete(CropImage_View view, Uri uri, Exception error) {
        if (error == null) {
    ...
    @Override
    public void onCropImageComplete(CropImage_View view, CropImage_View.CropResult result) {
