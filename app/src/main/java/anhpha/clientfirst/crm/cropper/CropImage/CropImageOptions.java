...
public class CropImageOptions implements Parcelable {
     ...
     */
    public  CropImage_View.CropShape cropShape;
     ...
     */
    public CropImage_View.Guidelines guidelines;

    /**
     * The initial scale type of the image in the crop image view
     */
    public CropImage_View.ScaleType scaleType;
     ...
     */
    public CropImage_View.RequestSizeOptions outputRequestSizeOptions;
    ...
    public CropImageOptions() {
        ...
        cropShape = CropImage_View.CropShape.RECTANGLE;
        ...
        guidelines = CropImage_View.Guidelines.ON_TOUCH;
        scaleType = CropImage_View.ScaleType.FIT_CENTER;
        ...
        outputRequestSizeOptions = CropImage_View.RequestSizeOptions.NONE;
        noOutputImage = false;
    ...
    protected CropImageOptions(Parcel in) {
        cropShape = CropImage_View.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = CropImage_View.Guidelines.values()[in.readInt()];
        scaleType = CropImage_View.ScaleType.values()[in.readInt()];
        ...
        outputRequestSizeOptions = CropImage_View.RequestSizeOptions.values()[in.readInt()];
