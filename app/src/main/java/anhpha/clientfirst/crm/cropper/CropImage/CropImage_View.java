 ...
 */
public class CropImage_View extends FrameLayout {
    ...
    public CropImage_View(Context context) {
        this(context, null);
    }

    public CropImage_View(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        View v = inflater.inflate(R.layout.activity_crop_image_view, this, true);
...
//    }
    ...
    public interface OnSetImageUriCompleteListener {
         ...
         */
        void onSetImageUriComplete(CropImage_View view, Uri uri, Exception error);
    }
    //endregion
    ...
    public interface OnCropImageCompleteListener {
         ...
         */
        void onCropImageComplete(CropImage_View view, CropResult result);
    }
    //endregion
