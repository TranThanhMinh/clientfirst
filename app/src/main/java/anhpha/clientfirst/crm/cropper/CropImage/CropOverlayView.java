...
package anhpha.clientfirst.crm.cropper.CropImage;
...
public class CropOverlayView extends View {
     ...
     */
    private CropImage_View.Guidelines mGuidelines;

    /**
     * The shape of the cropping area - rectangle/circular.
     */
    private CropImage_View.CropShape mCropShape;
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public CropImage_View.CropShape getCropShape() {
        return mCropShape;
    }
     ...
     * The shape of the cropping area - rectangle/circular.
     */
    public void setCropShape(CropImage_View.CropShape cropShape) {
        if (mCropShape != cropShape) {
            mCropShape = cropShape;
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17) {
                if (mCropShape == CropImage_View.CropShape.OVAL) {
     ...
     */
    public CropImage_View.Guidelines getGuidelines() {
        return mGuidelines;
    }
     ...
     */
    public void setGuidelines(CropImage_View.Guidelines guidelines) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCropWindowHandler.showGuidelines()) {
            ...
            if (mGuidelines == CropImage_View.Guidelines.ON) {
                drawGuidelines(canvas);
            } else if (mGuidelines == CropImage_View.Guidelines.ON_TOUCH && mMoveHandler != null) {
    ...
    private void drawBackground(Canvas canvas) {
        ...
        if (mCropShape == CropImage_View.CropShape.RECTANGLE) {
            ...
            mPath.reset();
            if (Build.VERSION.SDK_INT >= 11 && Build.VERSION.SDK_INT <= 17 && mCropShape == CropImage_View.CropShape.OVAL) {
    ...
    private void drawCorners(Canvas canvas) {
        if (mBorderCornerPaint != null) {
            ...
            float w = cornerWidth / 2 + (mCropShape == CropImage_View.CropShape.RECTANGLE ? mBorderCornerOffset : 0);
