...
final class CropWindowHandler {
     ...
     */
    public CropWindowMoveHandler getMoveHandler(float x, float y, float targetRadius, CropImage_View.CropShape cropShape) {
        CropWindowMoveHandler.Type type = cropShape == CropImage_View.CropShape.OVAL
