...
import anhpha.clientfirst.crm.cropper.cropwindow.CropOverlayView;
import anhpha.clientfirst.crm.cropper.cropwindow.edge.Edge;
import anhpha.clientfirst.crm.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    public void setImageUri(final Uri url) {

        Picasso.with(getContext()).load(url).resize(1000,getHeight()).into(mImageView, new com.squareup.picasso.Callback() {
            @Override
            ...
            public void onError() {
                ...
                Picasso.with(getContext()).load(url).fit().into(mImageView, new com.squareup.picasso.Callback() {
                    @Override
                    public void onSuccess() {
                        mBitmap = ((BitmapDrawable) mImageView.getDrawable()).getBitmap();
                    }
