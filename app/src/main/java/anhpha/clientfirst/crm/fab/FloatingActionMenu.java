package anhpha.clientfirst.crm.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), 3f);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = anhpha.clientfirst.crm.fab.Util.dpToPx(getContext(), mMenuShadowYOffset);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            anhpha.clientfirst.crm.fab.Label label = (anhpha.clientfirst.crm.fab.Label) child.getTag(R.id.fab_label);
            if (label != null) {
    ...
    private void addLabel(FloatingActionButton fab) {
        ...
        final anhpha.clientfirst.crm.fab.Label label = new anhpha.clientfirst.crm.fab.Label(mLabelsContext);
    ...
    private void setLabelEllipsize(anhpha.clientfirst.crm.fab.Label label) {
                ...
                if (child instanceof FloatingActionButton && child.getVisibility() != GONE) {
                    ...
                    mUiHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            anhpha.clientfirst.crm.fab.Label label = (anhpha.clientfirst.crm.fab.Label) fab.getTag(R.id.fab_label);
                ...
                if (child instanceof FloatingActionButton && child.getVisibility() != GONE) {
                    ...
                    mUiHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            anhpha.clientfirst.crm.fab.Label label = (Label) fab.getTag(R.id.fab_label);
                            if (label != null && label.isHandleVisibilityChanges()) {
                                label.hide(animate);
                            }
                        }
